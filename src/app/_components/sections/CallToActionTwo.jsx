                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className="mil-center">
                            ...
                            <h4 className="mil-upper mil-light mil-up mil-mb-60" dangerouslySetInnerHTML={{__html : Data.title}} />
                            ...
                            <br />
                            <div>
                                <p className="mil-accent mil-mb-5">Estamos listos para ayudarte a transformar tus ideas en realidad.</p>
                            </div>
                        </div>
                    </div>
                </div>
